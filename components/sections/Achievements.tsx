            ...
            <div className="">
              <div className=" grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
                <div>
                  ...
                  <h1 className=" text-4xl font-normal text-start bg-gradient-to-br from-white to-gray-500 bg-clip-text text-transparent max-w-xl  pt-3 mx-auto">
                    Competitions
                  </h1>
                  <p className=" text-start mx-auto max-w-xl pt-3 text-gray-500">
